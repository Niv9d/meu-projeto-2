function getProjects() {
  const urlGitHub = "https://api.github.com/users/Niv9d/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/Niv9d?tab=repositoriesl"]; // Link para o repositório no GitHub
    a.target = "_blank";
